...
CREATE TABLE [dbo].[DepartmentTable] (
    [Id]         INT          IDENTITY (1, 1) NOT NULL,
    [Department] VARCHAR (50) NOT NULL,
    CONSTRAINT [PK_DepartmentTable] PRIMARY KEY CLUSTERED ([Department] ASC)
);
...
GO
ALTER TABLE [dbo].[AbsentTable]
    ADD CONSTRAINT [FK_AbsentTable_ToDepartmentTable] FOREIGN KEY ([Department]) REFERENCES [dbo].[DepartmentTable] ([Department]);
...
GO
ALTER TABLE [dbo].[EmployeeTable]
    ADD CONSTRAINT [FK_EmployeeTable_ToDepartmentTable] FOREIGN KEY ([Department]) REFERENCES [dbo].[DepartmentTable] ([Department]);
...
GO
ALTER TABLE [dbo].[VacationTable]
    ADD CONSTRAINT [FK_VacationTable1_ToDepartmentTable] FOREIGN KEY ([Department]) REFERENCES [dbo].[DepartmentTable] ([Department]);
...
GO
ALTER TABLE [dbo].[WorkTable]
    ADD CONSTRAINT [FK_WorkTable_ToDepartmentTable] FOREIGN KEY ([Department]) REFERENCES [dbo].[DepartmentTable] ([Department]);
...
begin
	...
	DECLARE @EmpDepartment		VARCHAR(50)	= (
		SELECT Department FROM dbo.EmployeeTable WHERE EmployeeId = @EmpID AND EmpPass = @EmpPASS
		)
...
INSERT INTO dbo.VacationTable (EmployeeId, Department, StartDate, EndDate) VALUES (@EmpId, @EmpDEP, @StartDate, @EndDate);
GO
